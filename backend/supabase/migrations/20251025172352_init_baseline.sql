...
alter table "public"."creative_services" add column "payment_option" text not null default 'later'::text;

alter table "public"."creative_services" add column "requires_booking" boolean default false;

alter table "public"."creative_services" add constraint "creative_services_payment_option_check" CHECK ((payment_option = ANY (ARRAY['upfront'::text, 'split'::text, 'later'::text]))) not valid;

alter table "public"."creative_services" validate constraint "creative_services_payment_option_check";
