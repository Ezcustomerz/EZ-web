...
async def get_analytics_metrics(
    ...
    try:
        ...
        log_exception_if_dev(logger, "Failed to fetch analytics metrics", e)
        raise HTTPException(status_code=500, detail="Failed to fetch analytics metrics")
...
async def get_income_over_time(
    ...
    try:
        ...
        log_exception_if_dev(logger, "Failed to fetch income over time", e)
        raise HTTPException(status_code=500, detail="Failed to fetch income over time")
...
async def get_service_breakdown(
    ...
    try:
        ...
        log_exception_if_dev(logger, "Failed to fetch service breakdown", e)
        raise HTTPException(status_code=500, detail="Failed to fetch service breakdown")
...
async def get_client_leaderboard(
    ...
    try:
        ...
        log_exception_if_dev(logger, "Failed to fetch client leaderboard", e)
        raise HTTPException(status_code=500, detail="Failed to fetch client leaderboard")
